...
python ([src/pipeline.py](src/pipeline.py)) fetch-details --n 10

# Step 3: Parse details into structured JSON
python ([src/pipeline.py](src/pipeline.py)) parse-details --limit 10

# Step 4: End-to-end run (fetch + parse)
python ([src/pipeline.py](src/pipeline.py)) run --n 10
```
